...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Conectando con Electric Studio...", "author": "superstrella" }
        ]
        let splash = splashes[Math.floor(Math.random() * splashes.length)];
        this.splashMessage.textContent = "Conectando con Electric Studio...";
    ...
    shutdown(text) {
        this.setStatus(`${text}<br>Apagando en segundos`);
        let i = 4;
        setInterval(() => {
